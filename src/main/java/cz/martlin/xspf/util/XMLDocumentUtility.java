...
public class XMLDocumentUtility {
	 ...
	 * @throws XSPFException
	 */
	public <T> T getChildElementValueOrNull(Element owner, String elemName, NonNullTextToValueMapper<T> mapper)
			throws XSPFException {
	 ...
	 * @throws XSPFException
	 */
	public <T> void setChildElementValue(Element owner, String elemName, T value, NonNullValueToTextMapper<T> mapper)
			throws XSPFException {
	 ...
	 * @throws XSPFException
	 */
	public <T> T getElementValueOrNull(Element elem, NonNullTextToValueMapper<T> mapper) throws XSPFException {
	 ...
	 * @throws XSPFException
	 */
	public <T> void setElementValue(Element elem, T value, NonNullValueToTextMapper<T> mapper) throws XSPFException {
	 ...
	 * @throws XSPFException
	 */
	public <T> T getElementAttrOrNull(Element owner, String attrName, NonNullTextToValueMapper<T> mapper)
			throws XSPFException {
	 ...
	 * @throws XSPFException
	 */
	public <T> void setElementAttr(Element owner, String attrName, T value, NonNullValueToTextMapper<T> mapper)
			throws XSPFException {
